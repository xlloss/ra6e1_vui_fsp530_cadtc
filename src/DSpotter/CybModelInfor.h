...
typedef struct _MODEL_BUILDDATE
{
	SHORT m_sYear;      // Build year
	BYTE m_byMon;       // Build month
	BYTE m_byDay;       // Build day
	BYTE m_byHour;      // Build hour
	BYTE m_byMin;       // Build minute
	BYTE m_bySec;       // Build second
	BYTE m_byCentiSec;  // Build centisecond
} MODEL_BUILDDATE;
