...
DSPDLL_API INT DSpotter_SetAdvancedRejectionByGroup(HANDLE hDSpotter, INT nAdvancedRejectLevel, INT nGroupIdx);
...
// Copy from DSpotterSDKApi_Internal.h
...
// Extension by Ming
DSPDLL_API INT DSpotter_EnableModel(HANDLE hDSpotter, INT nModelIndex, BOOL bEnable);
DSPDLL_API BOOL DSpotter_ModelHasMapIDList(HANDLE hDSpotter);
DSPDLL_API SHORT *DSpotter_GetCmdMapIDList(HANDLE hDSpotter, INT nModelIndex, INT *pnErr);
DSPDLL_API SHORT *DSpotter_GetModelMapIDList(BYTE *lpbyModelInRAM);
DSPDLL_API INT DSpotter_SetCmdMapIDList(HANDLE hDSpotter, INT nModelIndex, SHORT *lpsMapID, INT nCommandCount);
