...
#ifndef DSPOTTERSDTRAIN_API_H__
#define DSPOTTERSDTRAIN_API_H__
...
DSPDLL_API INT DSpotterSD_TrainWord_WithMapID(HANDLE hDSpotter, char *lpszModelAddr, INT nBufSize, INT *pnUsedSize, SHORT sCmdMapID);
