...
void  elapsed_time_start (uint32_t  uSection)
{
    elapsed_time_tbl[uSection].start = ARM_CM_DWT_CYCCNT;
}
...
void  elapsed_time_stop (uint32_t  uSection)
{
    uint32_t       stop; 
    ELAPSED_TIME  *p_tbl;

    stop           = ARM_CM_DWT_CYCCNT;   
    p_tbl          = &elapsed_time_tbl[uSection];
...
void  elapsed_time_clr (uint32_t  uSection)
{
    ELAPSED_TIME  *p_tbl;
