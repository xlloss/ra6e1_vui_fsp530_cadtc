...
{
	// TRCENA, bit 24 => 1=DWT and ITM features enabled, 0=DWT and ITM features disabled
	// MON_EN, bit 16 => 1=Debug Monitor exception enabled. 0=Debug Monitor exception disabled.
