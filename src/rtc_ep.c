...
{
    #define BUFFER_SIZE_DOWN            50
    fsp_err_t err = FSP_SUCCESS;     // Error status
    #if 1
    unsigned char read_time[BUFFER_SIZE_DOWN] = {"15:07:2025 14:30:00"};
 ...
 **********************************************************************************************************************/
fsp_err_t get_rtc_calendar_time(rtc_time_t *get_rtc_time)
{
    fsp_err_t err = FSP_SUCCESS;     // Error status
